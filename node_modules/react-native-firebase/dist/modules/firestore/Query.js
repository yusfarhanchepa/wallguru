...
export default class Query {
  ...
  onSnapshot(optionsOrObserverOrOnNext, observerOrOnNextOrOnError, onError) {
    ...
    if (observer.error) {
      errorSubscription = SharedEventEmitter.addListener(getAppEventName(this._firestore, `onQuerySnapshotError:${listenerId}`), observer.error);
    ...
    return () => {
      ...
      if (errorSubscription) errorSubscription.remove(); // cancel native listener
